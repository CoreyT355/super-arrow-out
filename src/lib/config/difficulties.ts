...
export const DIFFICULTIES: Difficulty[] = [
    ...
    { label: 'Ludicrous', cells: 13000, square: false, color: 'from-fuchsia-500 to-fuchsia-600', ring: 'ring-fuchsia-400', chartColor: '#d946ef', hidden: false,
    ...
    { label: 'The Iron Tangle', cells: 25000, square: false, color: 'from-zinc-500 to-zinc-700', ring: 'ring-zinc-400', chartColor: '#71717a', hidden: false, unlockedBy: 'Ludicrous',
